  ...
  componentDidMount() {
    this.requestMatchSubscription = wsMgr.subscribe("requestMatch", msg => {
      switch(msg.request) {
        ...
        this.hasModifiedOverflowY = true;
        break;
        ...
        this.hasModifiedOverflowY = false;
        break;
  ...
  render() {
    ...
    return (
      <div>
        ...
        <GameInList name="Tetrablockz" title="Tetrablockz" description="Pas vraiment comme un certain autre jeu mais un peu quand même" image="/img/Tetrablockz.png"></GameInList>
