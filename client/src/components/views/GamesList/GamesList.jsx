  ...
  render() {
    ...
    return (
      <div>
        ...
        <GameInList name="Tetrablocks" title="Tetrablocks" description="Pas vraiment comme un certain autre jeu mais un peu quand même" image="/img/Tetrablocks.png"></GameInList>
